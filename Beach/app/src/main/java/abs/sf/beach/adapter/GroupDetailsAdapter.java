...
public class GroupDetailsAdapter extends RecyclerView.Adapter<GroupDetailsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, Context c) {
            ...
            ivRemoveParticipants = (ImageView) itemView.findViewById(R.id.ivRemoveParticipants);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        String userName = DbManager.getInstance().getUserName(member.getUserJID().getBareJID());
