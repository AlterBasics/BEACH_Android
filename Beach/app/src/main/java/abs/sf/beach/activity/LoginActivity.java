...
public class LoginActivity extends StringflowActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!SharedPrefs.getInstance().getLoginStatus()) {
            ...
            boolean authenticated = login(SharedPrefs.getInstance().getUsername(), SharedPrefs.getInstance().getPassword());
    ...
    private void initApplication() {
        TaskExecutor.submit(new Runnable() {
            ...
            public void run() {
                ...
                Platform.getInstance().getUserManager().sendGetChatRoomsRequest(UUIDGenerator.uuid());
            }
        });
    }
}
